            ...
            <div className="flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-50 text-gray-800">
                ...
                <form action="" className="space-y-12">
                    ...
                    <div className="space-y-2">
                        <div>
                            <button type="button" className="w-full px-8 py-3 font-semibold rounded-md bg-green-600 text-gray-50">Sign in</button>
                        </div>
                        <p className="px-6 text-sm text-center text-gray-600">Don't have an account yet?
                            <a rel="noopener noreferrer" href="#" className="hover:underline text-green-600">Sign up</a>.
                        </p>
                    </div>
                </form>
            </div>
