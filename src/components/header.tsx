                ...
                <ul className="items-stretch hidden space-x-3 md:flex">
                    ...
                    <li className="flex">
                        <Link href="/cart" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">
                            ...
                            <span className='flex flex-row items-center justify-center'>
                                <FaShoppingBag size={18} className='ml-2 mr-1 text-amber-600' />
                    ...
                    <li className="flex items-center justify-center">
                        {session ? (
                            ...
                            <Link href={'/auth/signin'} className="w-32 rounded text-white text-center p-2 bg-amber-600 border-transparent">
                                Entrar
                            </Link>
                        )}
